...
Использовал Codex(GPT 5.5)

Все промты ИИ документировал ниже. ИИ так себе делает интерфейс. Пришлось прогресс бар самому сделать.

Весть ИИ подход разбил на подзадачи. Видно в Boot-Flow\docs
